...
public class VolcanoNode implements ReadWriteNBT, DirtListener, SimulationTickable {
    static final String NBT_VOLCANO_NODE_TAG_LAST_ACTIVATION_TICK = NBTDictionary.GLOBAL.claim("volcLastTick");
    static final String NBT_VOLCANO_NODE_TAG_COOLDOWN_TICKS = NBTDictionary.GLOBAL.claim("volcCooldownTicks");
    static final String NBT_VOLCANO_NODE_TAG_POSITION = NBTDictionary.GLOBAL.claim("volPos");
    static final String NBT_VOLCANO_NODE_TAG_STAGE = NBTDictionary.GLOBAL.claim("volcStage");
    static final String NBT_VOLCANO_NODE_TAG_HEIGHT = NBTDictionary.GLOBAL.claim("volcHeight");
    static final String NBT_VOLCANO_NODE_TAG_WEIGHT = NBTDictionary.GLOBAL.claim("volcWeight");
